...
- OpenAPI client: `src/llm-benchmark-app/ui/lib/api/` (auto-generated)
- Routes: `src/llm-benchmark-app/ui/routes/`
- Components: `src/llm-benchmark-app/ui/components/`
- Backend: `src/llm-benchmark-app/backend/`
